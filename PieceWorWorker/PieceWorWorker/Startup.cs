...
using PieceWorWorker.Data;
using PieceWorWorker.Contexts;
using Microsoft.AspNetCore.Mvc;

namespace PieceWorWorker
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Here, we disable endpoint routing. It was an issue in upgrading from .NET Core 3.0
            services.AddMvc(options => options.EnableEndpointRouting = false);
            // Adding the connection string! Always just like this for our purposes.
            string connection = @"Server=(localdb)\mssqllocaldb;Database=PieceWorkWorkerDB;Trusted_Connection=true";
